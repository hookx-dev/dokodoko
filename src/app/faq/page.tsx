...
const faqs: { category: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      {
        q: "DokoDokoは無料で使えますか？",
        a: "はい、無料プランからすぐにお使いいただけます。無料プランでは地図の作成数（2つまで）、招待メンバー数（1地図あたり2人まで）、「行きたい」ピンの保持数・新規追加数に制限があります。月額500円のプレミアムプランにアップグレードすると、すべての制限がなくなります。詳しくは「料金プラン」ページをご覧ください。",
      },
      {
        q: "無料プランとプレミアムプランの違いは何ですか？",
        a: "無料プランは「地図2つまで」「1地図あたり招待メンバー2人まで」「『行きたい』ピンは同時に15件・1日3件の追加まで」という制限があります。プレミアムプラン（月額500円）ではこれらの制限がすべてなくなります。なお制限は地図のオーナーのプランに紐づくため、オーナーがプレミアムなら招待されたメンバーも制限なく利用できます。",
      },
      {
        q: "プレミアムプランはどうやって解約できますか？",
        a: "「アカウント設定」ページの「ご利用プラン」から「プランを管理する」を選択すると、Stripeの管理画面でいつでも解約できます。解約後も、それまでに保持していたデータが削除されることはありません（新規追加のみ制限がかかります）。",
      },
      {
        q: "アカウント登録には何が必要ですか？",
  ...
  },
  {
    ...
    items: [
      {
        q: "地図はいくつ作れますか？",
        a: "無料プランでは2つまで、プレミアムプランでは無制限に作成できます。パートナーとのデート用、友人との旅行用など、目的別に地図を使い分けられます。",
      },
      {
